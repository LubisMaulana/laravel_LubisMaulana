...
@section('container')
<form class="form-edit" action="/rumah-sakit/add" method="POST" style="width: 90%;max-width: 700px; margin:0 auto">
    @csrf
    <table class="table table-striped table-hover table-bordered border-success shadow p-3 mb-5 bg-body-tertiary rounded">
        <tbody>
            <tr>
                ...
                <td><input style="width: 100%; height:35px" type="text" name="nama" id="nama" placeholder="Masukkan nama rumah sakit" required></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input style="width: 100%; height:35px" type="email" name="email" id="email" placeholder="Masukkan email" required></td>
            </tr>
            <tr>
